...
<style scoped>
    ...
    ul li a{font-size: 14px;font-family: "Microsoft YaHei UI Light";font-weight: 700;}
    ...
    .lsTagbar li:nth-child(4){background:#d3d3d3}
    .lsTagbar li:nth-child(4) a{color: #41b833}
</style>
